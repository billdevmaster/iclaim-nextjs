...
const LinkPageButton = ({ href, text, className, type }) => {
  return (
    <Link href={href} class="rounded-[40px] bg-pink-main inline-flex justify-center items-center py-[30px] px-[40px] text-[20px] text-white leading-none font-medium text-center font-poppinsSemiBold relative z-10">
